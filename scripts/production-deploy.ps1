...
function Execute-Phase1 {
    ...
    Write-Deploy "Task 1.3: Environment Configuration..." "Yellow" ""
    if (Test-Path ".env.production") {
        Copy-Item ".env.production" ".env" -Force
        Write-Deploy " Production environment activated" "Green"
    }
    
    Write-Deploy "Task 1.4: Security Validation..." "Yellow" ""
...
"@
    ...
    foreach ($endpoint in $endpoints) {
        try {
            ...
            Write-Deploy "  Monitoring endpoint not ready: $endpoint" "Yellow"
        }
    }
...
function Execute-Phase3 {
    ...
    Write-Deploy "Task 3.1: Production Container Build..." "Yellow" ""
